...
def proxy_manifest():
    ...
    try:
        # Step 1: Get the redirect URL from AceStream
        ...
        # Step 2: Fetch the .m3u8 playlist from that redirect URL
        raw = requests.get(redirect_url, timeout=5)
        raw.raise_for_status()

        # Step 3: Rewrite segment URLs to use your public HTTPS domain
